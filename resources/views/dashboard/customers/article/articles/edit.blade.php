    ...
    <div class="page">
        <div class="page-inner">
            ...
            <div class="alert alert-danger">
                ...
                @endif
        <!-- .page-inner -->
        <form action="{{route('dashboard.customers.articles.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="mb-3">
              <label >Title</label>
              <input type="text" class="form-control" value="{{$slide['title2']}}" name="title2" >
            </div>
            <div class="mb-3">
                <label >Details</label>
