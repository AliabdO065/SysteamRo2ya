...
<div class="wrapper">
    ...
    <div class="page">
        ...
        <div class="page-inner">
            <a href="{{route('dashboard.customers.articles.add')}}" type="button" class="btn btn-success">Add articles</a> 
                <hr>
                ...
                <?php// print_r($content);  die; ?>
                        ...
                        <div class="card" style="width: calc(50% - 50px);display: flex;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{route('dashboard.customers.articles.edit',  $i )}}" class="btn btn-primary">Edit</a>
                                <a href="{{route('dashboard.customers.articles.delete',  $i )}}" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    @endforeach                        
                @endif
