...
<div class="wrapper">
    ...
    <div class="page">
        ...
        <!-- .page-inner -->
        <form action="{{route('dashboard.customers.services.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div class="mb-3">
            ...
            <div class="mb-3"> @error('img')<div class="alert alert-danger">{{ $message }}</div>@enderror
                ...
                <input  class="form-control" type="file"  accept="image/*,.gif" name="img2" class="@error('img2') is-invalid @enderror">
            </div>
