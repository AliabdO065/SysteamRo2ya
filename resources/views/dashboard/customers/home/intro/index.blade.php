    ...
    <div class="page">
        ...
        <form action="{{route('dashboard.customers.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 form-inline">
                <label  >Logo</label>
                <input type="hidden" name="imagel"  value="{{$slide['imgl']}}">
                <input style="width:30%" class="form-control" type="file" name="imgl">
                <img src="{{asset($slide['imgl'])}}" class="card-img-top" style ="width:100px;margin-left: 20PX;"  alt="...">
            </div>
